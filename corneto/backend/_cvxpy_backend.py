...
from corneto.backend._base import CtProxyExpression, CtProxySymbol, ProblemDef, Backend, _proxy
import numpy as np
import cvxpy as cp
        ...
        **options
        ...
        if max_seconds is not None:
            if s == "GUROBI":
                ...
                options["env"] = {"TimeLimit": max_seconds}
            elif s == "COIN_OR_CBC":
        ...
        P.solve(solver=s, verbose=verbosity > 0, **options)
        return P
